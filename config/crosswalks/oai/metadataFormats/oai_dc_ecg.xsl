...
<xsl:stylesheet 
	...
	<xsl:template match="/">
		<oai_dc_ecg:dc xmlns:oai_dc_ecg="http://www.cvrgrid.org/files/oai_dc_ecg/" 
			xmlns:dc="http://purl.org/dc/elements/1.1/" 
			xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" 
			xsi:schemaLocation="http://www.cvrgrid.org/files/oai_dc_ecg/ http://www.cvrgrid.org/files/oai_dc_ecg/oai_dc_ecg.xsd">
			<!-- dc.title -->
