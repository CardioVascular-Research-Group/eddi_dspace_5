...
<div id="tabs">
	...
	%><fmt:message key="jsp.submit.start-lookup-submission.manual-submission"/>
	<% 
	}
	%></a></h3>
...
<% } %>	
	...
	%> 
	  ><fmt:message key="jsp.submit.start-lookup-submission.identifiers"/></a></h3>
...
<% 
	...
	<div class="form-group" id="select-collection-file-div">
				...
				<select class="form-control submission-file-loader" name="select-collection-file" id="select-collection-file">
					...
					<option value="<%= c.getID() %>" <% if (c.getID() == Integer.parseInt(communitySet)){ %>selected="selected"<% } %>><%= c.getName() %></option>
					<% }  %>
				</select>
				</div>
	</div>
...
<div class="tab-pane" id="tabs-result">
		...
		<div id="manual-submission">
			...
			<div class="btn-group">
				<button class="btn btn-info col-md-offset-5" id="manual-submission-button" type="button"><fmt:message key="jsp.submit.start-lookup-submission.button.manual-submission"/> </button>
			</div>
			</form>
		</div>	
	</div>
	<div class="row container">
		...
		<div id="hidden-area" style="display: none;">
			...
			<div id="select-collection-div" style="display:none;">
				<select id="select-collection" class="form-control">				
					<option value="2" >ECG Publications</option>	
<%-- 					<% for (Collection c : collections) { %> --%>
